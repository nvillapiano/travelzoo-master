<body>
	...
	<section class="main-content">
		...
		<header>
			...
			<div class="todays-top-deals">
				Today's Top Deals 
			</div>
			<div class="spacer"></div>
		</header>

		<div class="row row-of-deals">
			<div class="secondary-deal">
				...
				<footer>
					...
					<div class="footer-headline">
						<div>
							Rome, Florence &amp; Venice Vacation w/Air
						</div>
						<h6 class="footer-subheadline">
							Italy
						</h6>						
					</div>
				</footer>
			...
			<div class="secondary-deal">
				...
				<footer>
					...
					<div class="footer-headline">
						<div>
							7-Night Cruises w/Drinks &amp; $300 Credit...
						</div>
						<h6 class="footer-subheadline">
							Alaska
						</h6>						
			...
			<div class="secondary-deal">
				...
				<footer>
					...
					<div class="footer-headline">
						<div>
							Weekend Brunch for 2 w/Cocktails...
						</div>
						<h6 class="footer-subheadline">
							South Africa
						</h6>						
		...
		<div class="row big-deal">
			...
			<div class="featured-content">
				<div class="featured-deal">
					...
					<footer>
						...
						<div class="footer-headline">
							<h3>
								Swim with Dolphins for Several Hours
							</h3>
							<h6 class="footer-subheadline">
								Florida
							</h6>						
						...
						<p>
							The Crane -- <a href="#">the first resort hotel ever built on Barbados</a> -- is located on a cliff directly above reef-protected Crane Beach, named the <b>number-one “Best Caribbean Beach” by readers of USA Today in 2015</b>.
							<br>
							Guests descend via glass elevator or staircase from the resort grounds to the soft sand, where swimmers can take invigorating dips in the turquoise waters. 
							shore-side. Guests can also savor the beach from afar and sip a cup of tea or a tropical cocktail on the veranda.
						</p>
					</footer>
				</div>
			</div>
			...
			<div class="secondary-content">
				...
				<div class="secondary-deal move-it">
					<div class="deal-image">
					</div>
					<footer>
						<div class="price">
		...
		<div class="row deals-with-circles">
			<div class="promo">
				<div class="circle">
					<div class="copy">
						<h5 class="circle-headline">
		...
		<div class="row deals-with-promo">
			...
			<div class="featured-content">
				<div class="featured-deal">
					...
					<footer>
						...
						<div class="footer-headline">
							<h3>
								Ruins in the Riviera Maya All-Inclusive Trip
							</h3>
							<h6 class="footer-subheadline">
								Tulum
							</h6>						
			...
			<div class="secondary-content">
				...
				<div class="secondary-deal">
					...
					<footer>
						...
						<div class="footer-headline">
							<div>
								Round-Trip Flights from the East Coast
							</div>
							<h6 class="footer-subheadline">
								On JetBlue
							</h6>						
	...
	<section class="more-deals">
		...
		<div class="button">
			<img src="images/more-deals.png" alt="Show me more deals">
			<span>
				Show me more deals
			</span>
		</div>
