<body class="deals-page third-party">
	...
	<section class="lockbar">
		...
		<div class="lockbar-wrapper">
			...
			<div class="deal">
				...
				<span class="headline">
					Cuba Guided Trip w/Air, Tours &amp; Cultural Exchanges
				</span>
				<span class="book-now">
					Book Now
				</span>
	...
	<section class="main-content">
		...
		<div class="deal-wrapper">
			<div class="images">
				<img src="images/cuba.jpg" alt="Deal - Punta Cana">
				<div class="caption">
			...
			<div class="copy">
				...
				<div class="description">
					Vibrant Cuba pulses to the beat of the timba and offers an escape to a world of vintage cars, lively city life and pristine beaches on this eight-night, guided trip loaded with unique activities for $2999 per person, including air.
				</div>
				<div class="source">
		...
		<div class="deal-guts">
			<div class="the-deal deal-tab show-me">
				<div class="col1">
					...
					<ul>
						<li>
							Be prepared to humblebrag among friends about snagging the lowest priced Cuba trip we've seen.
						</li>
						<li>
							Guided trip which knocks $1350 off the cost of similar packages
						</li>					
					</ul>
					<h6>
						What You Get
					...
					<ul>
						...
						<li>
							Three-night hotel stay in Havana
						</li>
					</ul>
				</div>
				<div class="col2">
			...
			<div class="the-deal details">
				<div class="col1">
					...
					<div class="where-it-is">
						<div>
							<strong>Hotel Occidental Miramar</strong><br>
							Playa<br>
							Havana, Cuba<br>
							Tel: +53 7 2043584<br>
							<a href="http://www.occidentalhotels.com/">www.occidentalhotels.com/</a>
						</div>
<!-- 						<div class="see-map">
					...
					<div class="map">
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14678.83664493798!2d-82.4377692!3d23.1077402!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8a1992c1fb61ffcc!2sHotel+Occidental+Miramar!5e0!3m2!1sen!2sus!4v1442412530133" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
					...
					<div class="fine-print">
						...
						<p>
							Price is per person, based on double occupancy. All packages are based on the lowest hotel/air 
							classes available at time of publication, capacity controlled, subject to availability and may 
							change without notice. Restrictions/blackout dates may apply. Please see the individual air 
							carrier’s website for a full detailed description of baggage charges before making your purchase. 
							Discovery Tours by Gate 1 has been granted a license by the Office of Foreign Assets Control (OFAC) 
							of the U.S. Department of the Treasury to provide People to People programs in Cuba. License 
							#CT-2013-304783-1.					
						</p>						
					</div>					
